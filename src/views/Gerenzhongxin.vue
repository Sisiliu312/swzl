    ...
    <body>
        ...
        <div class="shiyongshuoming" v-show="sysm">
            ...
            <div class="text">
                ...
                <div class="sysm-text">若找到对应帖子，则根据提供的联系方式 联系捡拾者；若未找到对应帖子，你可以 发布寻物帖，填写相关信息，系统会为你 匹配对应的招领帖； </div>
                <div class="sysm-title2">2.系统匹配</div>
                <div class="sysm-text">若匹配成功，系统会通知你查看确认；</div>
                <div class="sysm-title2">3.反馈结果 </div>
                <div class="sysm-text">匹配成功找到失物后，从“我的发布”删 除寻物帖； 匹配失败，可以删除系统匹配通知，继续耐心等待匹配结果。</div>
                ...
                <div class="sysm-title2">1.帖子只保留一个月，一个月后系统自动 删除帖子。</div>
            </div>
...
export default {
    ...
    methods:{
        ...
        toPipeitongzhi:function(){
            this.$router.push('/Pipeitongzhi')
        },
        toWodefabu:function(){
            this.$router.push('/Wodefabu')
        }
    },
    created(){
