            ...
            <div class="userFormBox">
                <div id="userForm">
                    <div class="diyInput" :style="{transform: aniInfo.inputTrans,}">
                        <div>
                            <input type="text" :placeholder="uiInfo.onfocus1?'':'用户名:'" v-model="loginForm.username" @focus="onFocus('onfocus1')" @blur="onBlur('onfocus1')">
                        </div>
                        <div>
                    ...
                    <div class="diyInput" :style="{transform: aniInfo.inputTrans}">
                        <div>
                            <input :type="eyeShow?'text':'password'" :placeholder="uiInfo.onfocus2?'':'密码:'" v-model="loginForm.password" @focus="onFocus('onfocus2')" @blur="onBlur('onfocus2')">
                            <img src="../assets/eye_hide.png" v-show="!eyeShow" @click="eyeShow=true">
                            <img src="../assets/eye_show.png" v-show="eyeShow" @click="eyeShow=false">
                        </div>
                        <div>
                            <transition name="stretch">
                    ...
                    <div id="loginBtn" class="diyBtn" @click="loginBtn" :style="{visibility:aniInfo.mainVisible?aniInfo.mainVisible:'unset',opacity:aniInfo.mainOpacity?aniInfo.mainOpacity:((loginForm.username && loginForm.password)?'1':'0.7'),transform:aniInfo.mainTrans}">
                        登录
                        <div @click.stop v-show="!loginForm.password || !loginForm.password"></div>
                    </div>
                    <div class="diySplitLine" :style="{visibility:aniInfo.mainVisible?aniInfo.mainVisible:'unset',opacity:aniInfo.mainOpacity?aniInfo.mainOpacity:'1',transform:aniInfo.mainTrans}">
                        <div class="line"></div>
                        <div class="text">OR</div>
                        <div class="line"></div>
                    </div>
                    <div id="registerBtn" class="diyBtn" @click="registerBtn" :style="{transform: aniInfo.reBTrans,backgroundColor:aniInfo.reBBgcolor,color:aniInfo.reBColor}">
                        注册
                    </div>
                </div>
            </div>
    ...
    watch:{
        pageTrigger(now,old){
            if(now){
                ...
                this.aniInfo.mainTrans = 'translateX(170px) translateY(-241px) rotate(2deg)'
